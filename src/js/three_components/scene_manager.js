...
export class SceneManager {
  ...
  resizeRendererToDisplaySize() {
    ...
    // Match dimension of canvas with dimension of video
  ...
  updateCamera() {
    // Camera need to be adjusted according to renderer dimensions
  ...
  animate() {
    ...
    if (this.resizeRendererToDisplaySize()) {
      ...
      // Facemask needs to scale faces according to renderer dimensions
      this.faceMask.updateDimensions(
        this.renderer.domElement.width, 
        this.renderer.domElement.height
      );

      // Renderer needs to scale glasses according to renderer dimensions
