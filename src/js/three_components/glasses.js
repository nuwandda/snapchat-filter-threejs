...
export class Glasses {
  ...
  async loadGlasses() {
    this.glasses = await loadModel( `${PUBLIC_PATH}/3d/glasses/scene.gltf` );
  ...
  updateGlasses() {
    ...
    if (this.glasses) {
      ...
      // Vertical Vector from midEyes to noseBottom is used for calculating rotation around x and z axis
      // Horizontal Vector from leftEyeCorner to rightEyeCorner us use to calculate rotation around y axis
